    ...
    <div class="left-panel">
      ...
      <div>
        ...
        <div class="contact-list">
          ...
          ${resumeContent.links?.portfolio ? `<div class="contact-row"><strong>Portfolio:</strong><a href="${resumeContent.links.portfolio}" target="_blank">${resumeContent.links.portfolio}</a></div>` : ''}
